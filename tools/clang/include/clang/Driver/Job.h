...
class FileSystemCommand : public Command {
  typedef std::function<std::error_code(const Twine &, const Twine &)>
          delegate_type;
  delegate_type Delegate;
public:
  FileSystemCommand(const Action &Source, const Tool &Creator,
                    const char *FakeExecutable, delegate_type Delegate,
...
class MoveFileCommand : public FileSystemCommand {
public:
  MoveFileCommand(const Action &Source, const Tool &Creator,
                  InputInfo Input, InputInfo Output);
};

class CopyFileCommand : public FileSystemCommand {
public:
  CopyFileCommand(const Action &Source, const Tool &Creator,
                  InputInfo Input, InputInfo Output);
};
