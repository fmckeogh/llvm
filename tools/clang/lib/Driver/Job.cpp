...
FileSystemCommand::FileSystemCommand(const Action &Source, const Tool &Creator,
                                     const char *FakeExecutable,
                                     delegate_type Delegate, InputInfo Input,
                                     InputInfo Output)
    : Command(Source, Creator, FakeExecutable,
...
MoveFileCommand::MoveFileCommand(const Action &Source, const Tool &Creator,
                                 InputInfo Input, InputInfo Output)
    : FileSystemCommand(Source, Creator, "mv", llvm::sys::fs::rename, Input,
                        Output) {}

CopyFileCommand::CopyFileCommand(const Action &Source, const Tool &Creator,
                                 InputInfo Input, InputInfo Output)
    : FileSystemCommand(Source, Creator, "cp", llvm::sys::fs::copy_file, Input,
                        Output) {}
