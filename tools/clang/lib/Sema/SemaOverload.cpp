...
class BuiltinOperatorOverloadBuilder {
  ...
  static const unsigned FirstPromotedIntegralType = 4,
                        LastPromotedIntegralType = 14;
  static const unsigned FirstPromotedArithmeticType = 0,
                        LastPromotedArithmeticType = 14;
  ...
  CanQualType getUsualArithmeticConversions(unsigned L, unsigned R) {
    ...
    enum PromotedType : int8_t {
           Dep=-1,
           Flt, Dbl,LDbl,  SI,  SL, S48, SLL,S128,  UI,  UL, U48, ULL,U128
    };
    static const PromotedType ConversionsTable[LastPromotedArithmeticType]
                                        [LastPromotedArithmeticType] = {
/* Flt*/ { Flt, Dbl,LDbl, Flt, Flt, Flt, Flt, Flt, Flt, Flt, Flt, Flt, Flt },
/* Dbl*/ { Dbl, Dbl,LDbl, Dbl, Dbl, Dbl, Dbl, Dbl, Dbl, Dbl, Dbl, Dbl, Dbl },
/*LDbl*/ {LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl,LDbl },
/*  SI*/ { Flt, Dbl,LDbl,  SI,  SL, S48, SLL,S128,  UI,  UL, U48, ULL,U128 },
/*  SL*/ { Flt, Dbl,LDbl,  SL,  SL, S48, SLL,S128, Dep,  UL, U48, ULL,U128 },
/* S48*/ { Flt, Dbl,LDbl, S48, S48, S48, SLL,S128, Dep, Dep, U48, ULL,U128 },
/* SLL*/ { Flt, Dbl,LDbl, SLL, SLL, SLL, SLL,S128, Dep, Dep, Dep, ULL,U128 },
/*S128*/ { Flt, Dbl,LDbl,S128,S128,S128,S128,S128,S128,S128,S128,S128,U128 },
/*  UI*/ { Flt, Dbl,LDbl,  UI, Dep, Dep, Dep,S128,  UI,  UL, U48, ULL,U128 },
/*  UL*/ { Flt, Dbl,LDbl,  UL,  UL, Dep, Dep,S128,  UL,  UL, U48, ULL,U128 },
/* U48*/ { Flt, Dbl,LDbl, U48, U48, U48, Dep,S128, U48, U48, U48, ULL,U128 },
/* ULL*/ { Flt, Dbl,LDbl, ULL, ULL, ULL, ULL,S128, ULL, ULL, ULL, ULL,U128 },
/*U128*/ { Flt, Dbl,LDbl,U128,U128,U128,U128,U128,U128,U128,U128,U128,U128 },
    };
    ...
    if (L == S48 || R == S48) return S.Context.UnsignedInt48Ty;
    assert(L == SLL || R == SLL);
