...
MCStreamer *createWasmStreamer(MCContext &Ctx, MCAsmBackend &TAB,
                               raw_pwrite_stream &OS, MCCodeEmitter *CE,
                               bool RelaxAll);
MCStreamer *createOMFStreamer(MCContext &Ctx, MCAsmBackend &TAB,
                              raw_pwrite_stream &OS, MCCodeEmitter *CE);
...
public:
  ...
  typedef MCStreamer *(*WasmStreamerCtorTy)(const Triple &T, MCContext &Ctx,
                                            ...
                                            MCCodeEmitter *Emitter,
                                            bool RelaxAll);
  typedef MCStreamer *(*OMFStreamerCtorTy)(const Triple &T, MCContext &Ctx,
                                           MCAsmBackend &TAB,
                                           raw_pwrite_stream &OS,
                                           MCCodeEmitter *Emitter);
  ...
  MCStreamer *createMCObjectStreamer(const Triple &T, MCContext &Ctx,
    ...
    case Triple::OMF:
      if (OMFStreamerCtorFn)
        S = OMFStreamerCtorFn(T, Ctx, TAB, OS, Emitter);
      else
        S = createOMFStreamer(Ctx, TAB, OS, Emitter);
      break;
    }
